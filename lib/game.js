...
function onSocketConnection (client) {
  ...
  // Listen for new ai player message
  client.on('new ai player', onNewAIPlayer)
...
// New ai player has joined
function onNewAIPlayer (data) {
  // Create a new ai player
  var newAIPlayer = new AIPlayer(data.x, data.y, data.angle, data.ver, data.health, data.team, data.username)

  // Broadcast new player to connected socket clients
  this.broadcast.emit('new ai player', {id: newAIPlayer.id, x: newAIPlayer.getX(), y: newAIPlayer.getY(), angle: newAIPlayer.getAngle(), ver: newAIPlayer.getVer(), health: newAIPlayer.getHealth(), team: newAIPlayer.getTeam(), username: newAIPlayer.getUsername()})
