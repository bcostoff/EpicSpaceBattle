...
function onNewPlayer (data) {
  ...
  for (i = 0; i < players.length; i++) {
    ...
    this.emit('new player', {id: existingPlayer.id, x: existingPlayer.getX(), y: existingPlayer.getY(), angle: existingPlayer.getAngle(), ver: existingPlayer.getVer(), health: existingPlayer.getHealth()})
