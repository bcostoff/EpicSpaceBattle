...
MiniMap.prototype.update = function (player,enemies,capitalG,capitalB) {
    unitDots.clear();            
    ...
    var cunitMiniX = capitalG.capitalShip.x * renderTexture.resolution;        
    var cunitMiniY = capitalG.capitalShip.y * renderTexture.resolution;    
    var color = '0x197b30';    
    unitDots.beginFill(color);   
    unitDots.drawRect(cunitMiniX, cunitMiniY, 4, 4);   

    var cunitMiniX = capitalB.capitalShip.x * renderTexture.resolution;        
    var cunitMiniY = capitalB.capitalShip.y * renderTexture.resolution;    
    var color = '0x306f9f';    
    unitDots.beginFill(color);   
    unitDots.drawRect(cunitMiniX, cunitMiniY, 4, 4);    
}
